...
class HomeEmployee:
    ...
    def create_menu(self, event):
        if self.menu is not None:
            ...
            #under Menu name
            flight_menu.add_command(label="flight available", command=self.redirect_to_window_flight_available)
    ...
    def redirect_to_window_flight_available(self, event):
        self.accountPage_window = tk.Toplevel(self.root)
        self.app = PlaneBooking.BookingApp(self.accountPage_window)
    ...
    def redirect_to_edit_flight(self):
        ...
        self.app = FlightBooking.FlightSelectionPage(self.editFlight_window)
